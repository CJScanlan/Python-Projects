...
#
# Purpose:  The Tech Academy - Python Course, Creating a first program
#           Demonstrating how to pass variables from function to function
#           while producing a functional game.
#
#           Function_name(variable) means that we pass in the variable.
#           return variabble means that we are returning the variable
...
def describe_game(name):
    """
        check is this is a new game or not.
