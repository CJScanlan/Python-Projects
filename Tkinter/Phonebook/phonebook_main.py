...
class ParentWindow(Frame):
    def __init__(self, master, *args, **kwargs):
        ...
        """
            Finally, we apply the config method of the widgit to display the menu
...
"""
    ...
    The (if __name__== "__main__":) part is basically telling Python that is this script
    is ran, it should start by running the code below this line...in this case we have
    instructed Python to start the following and in this order:
